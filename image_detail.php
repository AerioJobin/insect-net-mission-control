...
<head>
    ...
    <style>
        ...
        * {
        ...
        [data-theme="dark"] .conf-change.up {
            background: #052e16;
            color: #4ade80;
        }

        [data-theme="dark"] .conf-change.down {
            background: #1f0808;
            color: #f87171;
        }
        ...
        .status-kept {
            background: #fef9c3;
            color: #a16207;
            box-shadow: 0 0 12px rgba(161, 98, 7, 0.25);
        }
        ...
        [data-theme="dark"] .error-raw-details {
            ...
            <div class="img-panel">
                ...
                <div class="img-meta">
                    ...
                    <div class="img-actions">
                        <a href="<?= htmlspecialchars($imagePath) ?>" download="<?= htmlspecialchars($imageFile) ?>"
                            class="btn-download">Save Image</a>
                    </div>
                </div>
            </div>
            ...
            <div class="ai-panel">
                <?php if ($cached): ?>
                    ...
                    <div class="btn-row">
                        ...
                        <button class="btn-secondary" id="forceBtn"
                            title="Ignore confidence, always save fresh result">Force Fresh</button>
